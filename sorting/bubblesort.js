//Bubble sort is a simpel sorting algorithm that repeatedl steps through the list to be sorted 
...
function bubbleSortThis(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        for (let j = 1; j < arr.length; j++) {
            ...
            if (arr[j - 1] > arr[j]) {                      //if the value in the previous position is greater 
